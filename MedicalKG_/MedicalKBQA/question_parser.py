...
class QuestionPaser:
    ...
    def sql_transfer(self, question_type, entities):
        ...
        # 查询症状会导致哪些疾病
            ...
            sql = ["MATCH (m:Disease)-[r:has_symptom]->(n:Symptom) where n.name contains '{0}' return m.name, r.name, n.name".format(i) for i in entities]
            
            #sql = ["MATCH (m:Dis(m:Symtom) where m.name = '{0}' return m.name".format(i) for i in entities]
